...
set_property PROBES.FILE {nucleikit/obj/system.ltx} [get_hw_devices ${device}]
set_property PROGRAM.FILE {nucleikit/obj/system.bit} [get_hw_devices ${device}]
...
# set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes mcu_rst -of_objects [get_hw_ilas -of_objects [get_hw_devices ${device}]]]
# set_property CONTROL.TRIGGER_CONDITION OR [get_hw_ilas -of_objects [get_hw_devices ${device}]]


set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes iobuf_gpio_16_o -of_objects [get_hw_ilas -of_objects [get_hw_devices ${device}]]]
set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes iobuf_gpio_17_o -of_objects [get_hw_ilas -of_objects [get_hw_devices ${device}]]]
set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes clk_16M -of_objects [get_hw_ilas -of_objects [get_hw_devices ${device}]]]
...
display_hw_ila_data [upload_hw_ila_data [get_hw_ilas -of_objects [get_hw_devices ${device}]]]
